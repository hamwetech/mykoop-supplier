...
from userprofile.forms import GroupForm, PlatformForm, AccessLevelForm, AccessLevelGroupForm, LoginForm
...
class PlatformCreateView(CreateView):
    ...
    success_url = reverse_lazy('profile:platform_list')
...
class ChangePasswordView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.error(request, 'Sorry password Denied. Please use a password different from your previous %s passwords' %
                           system_settings.password_reuse_threshold)
        return render(request, self.template_name, {'form': form})
